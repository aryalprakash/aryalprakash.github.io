    ...
    render (){
        ...
        return(
            <div className="row sub-category">
                {subcategories?subcategories.grocery.map(subcategory =>
                    <div key={subcategory.id} className="sub-category-list col-md-6">
                        <div className="row">
                            ...
                            <div className="col-md-7">
                                ...
                                {Object.keys(subcategory.product).forEach(function(key,index){

                                        item.push(<p key={index}>{key}: {subcategory.product[key].map((o, i) =><span key={i}>{o}, </span>)} </p>);
                                        }
                                    )
                                }
                                {item}
